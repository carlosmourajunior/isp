...
urlpatterns = [
    ...
    path('update-olt-system/', views.update_olt_system_data, name='update_olt_system_data'),
    path('temperature-alerts/', views.list_temperature_alerts, name='list_temperature_alerts'),
